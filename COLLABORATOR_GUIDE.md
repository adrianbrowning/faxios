...
- Keep the public type surface in `packages/lib/src/lib/types.ts` correct when the public API changes; `index.d.ts` is generated by `zshy` (ESM-only, no CJS build).
