    ...
    items: [
      ...
      { text: "功能特性", link: "/zh/pages/getting-started/features" },
      {
        ...
        items: [
          {
            text: "JavaScript",
            link: "/zh/pages/getting-started/examples/commonjs",
          },
          {
            text: "TypeScript",
            link: "/zh/pages/getting-started/examples/typescript",
          },
        ],
      },
      {
        text: "升级指南 v0.x -> v1.x",
        link: "/zh/pages/getting-started/upgrade-guide",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        text: "请求方法别名",
        link: "/zh/pages/advanced/request-method-aliases",
      },
      ...
      {
        text: "Multipart/form-data 格式",
        link: "/zh/pages/advanced/multipart-form-data-format",
      },
...
const esSidebar = [
    ...
    items: [
      ...
      { text: "Características", link: "/es/pages/getting-started/features" },
      {
        ...
        items: [
          {
            text: "JavaScript",
            link: "/es/pages/getting-started/examples/commonjs",
          },
          {
            text: "TypeScript",
            link: "/es/pages/getting-started/examples/typescript",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "Alias de métodos de solicitud",
        link: "/es/pages/advanced/request-method-aliases",
      },
      {
        text: "Crear una instancia",
        link: "/es/pages/advanced/create-an-instance",
      },
      {
        text: "Configuración de solicitud",
        link: "/es/pages/advanced/request-config",
      },
      { text: "Adaptadores", link: "/es/pages/advanced/adapters" },
      {
        text: "Esquema de respuesta",
        link: "/es/pages/advanced/response-schema",
      },
      {
        text: "Configuración predeterminada",
        link: "/es/pages/advanced/config-defaults",
      },
      ...
      {
        text: "Reintento y recuperación de errores",
        link: "/es/pages/advanced/retry",
      },
      ...
      {
        text: "Publicación de archivos",
        link: "/es/pages/advanced/file-posting",
      },
      {
...
const frSidebar = [
    ...
    items: [
      ...
      { text: "Fonctionnalités", link: "/fr/pages/getting-started/features" },
      {
        ...
        items: [
          {
            text: "JavaScript",
            link: "/fr/pages/getting-started/examples/commonjs",
          },
          {
            text: "TypeScript",
            link: "/fr/pages/getting-started/examples/typescript",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "Alias des méthodes de requête",
        link: "/fr/pages/advanced/request-method-aliases",
      },
      {
        text: "Créer une instance",
        link: "/fr/pages/advanced/create-an-instance",
      },
      {
        text: "Configuration des requêtes",
        link: "/fr/pages/advanced/request-config",
      },
      ...
      {
        text: "Format Multipart/form-data",
        link: "/fr/pages/advanced/multipart-form-data-format",
      },
      ...
      {
        text: "Capture de la progression 🔥",
...
export default defineConfig({
  ...
  description: "Documentation for the faxios HTTP project",
  head: [
  ...
  themeConfig: {
    ...
    siteTitle: false,
    socialLinks: [{ icon: "github", link: "https://github.com/faxios/faxios" }],
    footer: {
      message: "faxios is provided under MIT license",
      copyright: "Copyright © 2015-present faxios collective",
    },
  },
});
