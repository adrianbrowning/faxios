...
import type { FormDataVisitorHelpers, GenericFormData } from "../types.js";
import utils from "../utils.js";
import toFormData from "./toFormData.js";

export default function toURLEncodedForm(data: unknown, options?: Record<string, unknown>) {
  return toFormData(data, new platform.classes.URLSearchParams() as unknown as GenericFormData, {
