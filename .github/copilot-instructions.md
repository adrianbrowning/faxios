...
- Source is ESM (`type: module`) with explicit `.js` import extensions. `dist/` is generated by `zshy` — never edit it by hand. Keep `index.d.ts` in sync for any public API change (ESM-only; no CJS build).
